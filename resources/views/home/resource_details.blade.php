...
.services4 .container {
    background: url(assets/img/blog-img.png) center center;
...
.breadcrumbs .page-header {
    ...
    background-image: url('assets/img/Rectangle\ 92.png');
    background-size: cover;
        ...
        <a class="nav-link dropdown-toggle  " href="services"   role="button"
         data-bs-toggle="dropdown" aria-expanded="false">Services</a>
          ...
          <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="sales.html" >Sales Essentials</a></li>
              <li><a class="dropdown-item" href="culture.html">Work Place Culture and Accountability</a></li>
...
<!-- End Header -->
  <main id="main"> 
    ...
    <div class="breadcrumbs">
      <div class="page-header d-flex align-items-center banner-with-text" style="background-image: url('assets/img/Rectangle\ 92.png');">
      ...
      <section id="recent-posts" class="recent-posts ">
        <div class="container" data-aos="fade-up">
          ...
          <h3 class=" mb-3">Digital Transformation eBook (BLOG)</h3>
    <p class="mb-2">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
    ...
    <section id="stats-counter " class="stats-counter">
        ...
        <div class="container " data-aos="fade-up">
          ...
          <div class="row gy-4 align-items-center bg-clr mt-5">
            ...
            <div class="col-lg-7">
              ...
              <P class=" mb-5 clr ">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
                corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa 
                qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita 
                                                  distinctio Ut enim ad minima veniam, quis nostrum exercitationem ullam.</p>
          ...
          <div class="col-lg-5">
            ...
            <img src="assets/img/Ellipse 30.png" alt="" class="img-fluid">
          ...
          <div class="row gy-4 align-items-center mt-5 bg-clr1">
            ...
            <div class="col-lg-7">
              ...
              <h3> Business And Financial Acumen for B2B Sales </h3>
            ...
            <div class="col-lg-5">
              <div class="image-box text-center">
              <img src="assets/img/Ellipse 31.png" alt="" class="img-fluid mx-auto">
  
            </div>
            </div>

            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio Ut enim ad minima veniam, quis nostrum exercitationem ullam. Et harum quidem rerum facilis sunt.</p>
    ...
    <div class="container">
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6 footer-links">
          <h4>Our Services</h4>
          <ul>
            <li><a href="sales.html">Sles Essentials</a></li>
            <li><a href="culture.html">Work Place Culture and Accountability</a></li>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          <h4>Contact Us</h4>
          <p>
            <strong>Location:</strong> Regus business centre, Level 9, Platina Building
            Bandra Kurla complex Mumbai,
            Maharashtra - 400051<br>
             
            <strong>Phone:</strong> <a href="tel:+912267000868">+91 22 6700 0868</a><br>
